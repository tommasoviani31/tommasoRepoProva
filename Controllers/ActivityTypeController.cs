...
namespace TMmvc.Controllers
{
    public class ActivityTypeController : Controller
    {
        ...
        public ActivityTypeController(TMContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,IsExternal")] ActivityType activityType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,IsExternal")] ActivityType activityType)
        {
